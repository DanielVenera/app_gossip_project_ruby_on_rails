...
10.times do
  ...
  while a.sender == a.recipient #in order to not have a sender sending a message to himself
...
20.times do
    count += 1
  Comment.create(id: count, content: ["OMG", "LMFAO", "XD", "c nul"].sample, gossip: Gossip.find(rand(1..20)), user: User.find(rand(1..10)))
end
